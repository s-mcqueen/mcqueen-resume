...
Software Engineer with 5 years of experience. Experienced building high scale systems and high quality tools.

%----------------------------------------------------------------------------------------

\section{EXPERIENCE}

% {\sl Senior Software Engineer, ML} \hfill April 2019 - present \\
% \href{http://www.twitter.com}{Twitter}, New York, NY \\
% I help product teams at Twitter leverage machine learning to achieve business goals.
% \begin{itemize} \itemsep -1pt % Reduce space between items
% \item I work on the Machine Learning Platform Tools team within Cortex
% \end{itemize}
