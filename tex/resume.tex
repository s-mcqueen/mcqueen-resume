...
\href{http://www.nextdoor.com}{Nextdoor}, San Francisco, CA
\begin{itemize} \itemsep -2pt % Reduce space between items
\item Joined the Infrastructure team and helped write the client library to an asynchronous backend newsfeed content service. The new service was multi-threaded and stateless, giving us horizontal scalability that reduced server costs and allowed us to optimize our newsfeed load times, leading to a 2X speed up on our most important pages.
\end{itemize}
